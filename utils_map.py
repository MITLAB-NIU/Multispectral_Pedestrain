...
def log_average_miss_rate(precision, fp_cumsum, num_images, class_name):
    """
    ...
    # plt.plot(fppi,mr)
    # plt.title(str(class_name)+" Miss Rate = "+str(min(mr)))
    # plt.xlabel("FPPI")
    # plt.ylabel("MR")
    # plt.xscale("log")
    # plt.show()
...
def get_map(MINOVERLAP, draw_plot, path = './map_out'):
    ...
    if True:
        ...
        os.makedirs(os.path.join(RESULTS_FILES_PATH, "MR"))
    if show_animation:
    ...
    with open(RESULTS_FILES_PATH + "/results.txt", 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            lamr, mr, fppi = log_average_miss_rate(np.array(rec), np.array(fp), n_images, class_name)
            lamr_dictionary[class_name] = lamr

            # plt.title('class: ' + str(class_name)+" Miss Rate = "+str(min(mr)))
            # plt.xlabel('false positives per image(FPPI)')
            # plt.ylabel('miss rate(MR)')
            # plt.xscale("log")
            # plt.plot(fppi, mr, 'g')
            # plt.savefig(RESULTS_FILES_PATH + "/MR/" + class_name + ".png")
            # plt.clf()
            # plt.plot(fppi,mr)
